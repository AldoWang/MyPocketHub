...
public class LabelDrawableSpan extends DynamicDrawableSpan {
    ...
    private static class LabelDrawable extends PaintDrawable {
        ...
        public LabelDrawable(final float paddingLeft, final float textHeight, final Rect bounds
            ...
            layers = (LayerDrawable) resources.getDrawable(R.drawable.label_background);
            ((GradientDrawable) ((LayerDrawable) layers.findDrawableByLayerId(R.id.item_outer_layer)).findDrawableByLayerId(R.id.item_outer)).setColor(bg);
            ((GradientDrawable) ((LayerDrawable) layers.findDrawableByLayerId(R.id.item_inner_layer)).findDrawableByLayerId(R.id.item_inner)).setColor(bg);
            ((GradientDrawable) layers.findDrawableByLayerId(R.id.item_bg)).setColor(bg);
    ...
    public static void setText(final TextView view, final Collection<Label> labels) {
        ...
        Arrays.sort(sortedLabels, new Comparator<Label>() {
            ...
            public int compare(Label o1, Label o2) {
                return CASE_INSENSITIVE_ORDER.compare(o1.name(), o2.name());
            }
        });
