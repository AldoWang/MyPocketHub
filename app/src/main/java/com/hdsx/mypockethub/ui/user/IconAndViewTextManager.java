...
import com.hdsx.mypockethub.util.TimeUtils;
...
public class IconAndViewTextManager {
    ...
    private void appendCommitComment(final StyledText details, final GitComment comment) {
        if (comment == null) {
            return;
        }
    ...
    void formatCommitComment(GitHubEvent event, StyledText main, StyledText details) {
    ...
    void formatDownload(GitHubEvent event, StyledText main, StyledText details) {
        boldActor(main, event);
    ...
    void formatCreate(GitHubEvent event, StyledText main, StyledText details) {
        boldActor(main, event);
    ...
    void formatFork(GitHubEvent event, StyledText main, StyledText details) {
        boldActor(main, event);
    ...
    void formatIssueComment(GitHubEvent event, StyledText main, StyledText details) {
        boldActor(main, event);
    ...
    void formatAddMember(GitHubEvent event, StyledText main, StyledText details) {
    ...
    void formatWatch(GitHubEvent event, StyledText main, StyledText details) {
        boldActor(main, event);
        main.append(" starred ");
        boldRepo(main, event);
    }

    void formatReviewComment(GitHubEvent event, StyledText main, StyledText details) {
        boldActor(main, event);
        main.append(" commented on ");
        boldRepo(main, event);
